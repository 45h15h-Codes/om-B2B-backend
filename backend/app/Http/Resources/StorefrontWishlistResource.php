...
class StorefrontWishlistResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        if ($this->product_type === 'diamond') {
            ...
            if ($diamond) {
                $caratStr = $diamond->size ? floatval($diamond->size) . ' Carat ' : '';
                ...
                $availability = $diamond->inventory_status === 'available';
            }
            ...
            if ($jewellery) {
                ...
                $availability = $jewellery->inventory_status === 'available';
            }
        }
